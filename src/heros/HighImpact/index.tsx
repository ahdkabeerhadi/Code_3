    ...
    <section className="max-w-7xl w-full px-4 sm:px-6 mx-auto flex flex-col flex-1 mt-10 md:mt-14 lg:mt-20 items-center relative">
      <div className="font-sans w-full ">
        <div className="max-w-5xl">
          ...
          {subText && <p className="my-6 text-xl text-balance ">{subText}</p>}
        </div>
        <div>
      ...
      <div className="w-full flex flex-col min-h-[20vh] mt-6 md:min-h-[30vh] xl:min-h-[80vh] object-fill relative items-center justify-center text-foreground ">
