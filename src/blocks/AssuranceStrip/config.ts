  ...
  fields: [
    {
      ...
      fields: [
        ...
        { name: 'title', type: 'text', required: true, localized: true, admin: { description: 'e.g. "Fully Insured Transport"' } },
        { name: 'text', type: 'text', required: true, localized: true, admin: { description: 'Short one-line note.' } },
      ],
    },
  ],
}
